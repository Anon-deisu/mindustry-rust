...
pub fn build_runtime_live_entity_panel(hud: &HudModel) -> Option<RuntimeLiveEntityPanelModel> {
    ...
    Some(RuntimeLiveEntityPanelModel {
        ...
        local_owned_unit_entity_id: entity.local_owned_unit_entity_id,
        local_owned_unit_payload_count: entity.local_owned_unit_payload_count,
        local_owned_unit_payload_class_id: entity.local_owned_unit_payload_class_id,
        local_owned_unit_payload_revision: entity.local_owned_unit_payload_revision,
        local_owned_unit_payload_body_len: entity.local_owned_unit_payload_body_len,
...
mod tests {
    ...
    #[test]
    fn build_config_alignment_label_maps_none_true_and_false_stably() {
        assert_eq!(build_config_alignment_label(None), "none");
        assert_eq!(build_config_alignment_label(Some(true)), "match");
        assert_eq!(build_config_alignment_label(Some(false)), "split");
    }
