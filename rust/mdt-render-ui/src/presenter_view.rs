...
#[derive(Clone, Copy)]
struct RuntimeUiNoticeCommonFields<'a> {
    hud_set_count: u64,
    hud_set_reliable_count: u64,
    hud_hide_count: u64,
    hud_last_message: Option<&'a str>,
    hud_last_reliable_message: Option<&'a str>,
    announce_count: u64,
    last_announce_message: Option<&'a str>,
    info_message_count: u64,
    last_info_message: Option<&'a str>,
    toast_info_count: u64,
    toast_warning_count: u64,
    toast_last_info_message: Option<&'a str>,
    toast_last_warning_text: Option<&'a str>,
    info_popup_count: u64,
    info_popup_reliable_count: u64,
    last_info_popup_reliable: Option<bool>,
    last_info_popup_id: Option<&'a str>,
    last_info_popup_message: Option<&'a str>,
}

fn runtime_ui_notice_common_fields(
    panel: &RuntimeUiNoticePanelModel,
) -> RuntimeUiNoticeCommonFields<'_> {
    RuntimeUiNoticeCommonFields {
        hud_set_count: panel.hud_set_count,
        hud_set_reliable_count: panel.hud_set_reliable_count,
        hud_hide_count: panel.hud_hide_count,
        hud_last_message: panel.hud_last_message.as_deref(),
        hud_last_reliable_message: panel.hud_last_reliable_message.as_deref(),
        announce_count: panel.announce_count,
        last_announce_message: panel.last_announce_message.as_deref(),
        info_message_count: panel.info_message_count,
        last_info_message: panel.last_info_message.as_deref(),
        toast_info_count: panel.toast_info_count,
        toast_warning_count: panel.toast_warning_count,
        toast_last_info_message: panel.toast_last_info_message.as_deref(),
        toast_last_warning_text: panel.toast_last_warning_text.as_deref(),
        info_popup_count: panel.info_popup_count,
        info_popup_reliable_count: panel.info_popup_reliable_count,
        last_info_popup_reliable: panel.last_info_popup_reliable,
        last_info_popup_id: panel.last_info_popup_id.as_deref(),
        last_info_popup_message: panel.last_info_popup_message.as_deref(),
    }
}

pub(crate) fn format_runtime_ui_notice_panel_text(panel: &RuntimeUiNoticePanelModel) -> String {
    let fields = runtime_ui_notice_common_fields(panel);
    format!(
        "notice:hud={}/{}/{}@{}/{}:ann={}@{}:info={}@{}:toast={}/{}@{}/{}:popup={}/{}@{}:{}/{}:clip={}@{}:uri={}@{}:{}:tin={}@{}:{}/{}/{}#{}:n{}:e{}",
        fields.hud_set_count,
        fields.hud_set_reliable_count,
        fields.hud_hide_count,
        compact_runtime_ui_text(fields.hud_last_message),
        compact_runtime_ui_text(fields.hud_last_reliable_message),
        fields.announce_count,
        compact_runtime_ui_text(fields.last_announce_message),
        fields.info_message_count,
        compact_runtime_ui_text(fields.last_info_message),
        fields.toast_info_count,
        fields.toast_warning_count,
        compact_runtime_ui_text(fields.toast_last_info_message),
        compact_runtime_ui_text(fields.toast_last_warning_text),
        fields.info_popup_count,
        fields.info_popup_reliable_count,
        format_optional_bool_flag(fields.last_info_popup_reliable),
        compact_runtime_ui_text(fields.last_info_popup_id),
        compact_runtime_ui_text(fields.last_info_popup_message),
...
pub(crate) fn format_runtime_ui_notice_detail_text(
    ...
    Some(format!(
        ...
        fields.hud_set_reliable_count,
        fields.hud_hide_count,
        runtime_ui_text_len(fields.hud_last_message),
        runtime_ui_text_len(fields.hud_last_reliable_message),
        fields.announce_count,
        runtime_ui_text_len(fields.last_announce_message),
        fields.info_message_count,
        runtime_ui_text_len(fields.last_info_message),
        fields.toast_info_count,
        fields.toast_warning_count,
        runtime_ui_text_len(fields.toast_last_info_message),
        runtime_ui_text_len(fields.toast_last_warning_text),
        fields.info_popup_count,
        fields.info_popup_reliable_count,
        format_optional_bool_flag(fields.last_info_popup_reliable),
        runtime_ui_text_len(fields.last_info_popup_id),
        runtime_ui_text_len(fields.last_info_popup_message),
...
fn runtime_world_reload_from_loading(
    loading: &RuntimeLoadingPanelModel,
) -> Option<&RuntimeWorldReloadPanelModel> {
    loading.last_world_reload.as_ref()
}

fn format_runtime_world_reload_panel_text_from_loading(
    loading: &RuntimeLoadingPanelModel,
) -> String {
    format_runtime_world_reload_panel_text(runtime_world_reload_from_loading(loading))
}
...
pub(crate) fn compose_runtime_notice_state_text_from_hud<F>(
    hud: &HudModel,
    formatter: F,
) -> Option<String>
where
