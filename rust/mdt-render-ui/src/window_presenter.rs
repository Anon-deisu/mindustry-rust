...
mod tests {
    ...
    fn present_once_surfaces_build_config_overflow_and_extended_minimap_counts() {
        ...
        assert_frame_line_contains(
            &frame.panel_lines,
            "BUILD-MINIMAP-AUX: preb:m=place:s=head-aligned:q=mixed:r1:cfg=3/7@gamma:auth=rej-miss-build:pm=match:head=10:12:tile=10:12:src=tilecfg:b=gamma:f=0:0@1:v0:u100:w0:d75:obj3:rt0:rs0",
        );
        assert_frame_line_contains(
            &frame.panel_lines,
