...
mod tests {
    ...
    #[test]
    fn strict_connect_build_ignores_unrelated_release_metadata_while_preserving_157_2_alignment() {
        let version_properties = b"#Autogenerated file. Do not modify.\r\nnumber=8\nbuild=157.2\nmodifier=release\nbuildDate=unknown\ntype=official\ncommitHash=c5e5768\n";

        assert_eq!(
            strict_connect_build(version_properties),
            Ok(157)
        );
        assert_eq!(strict_connect_version_type(version_properties), Ok("official"));
    }
