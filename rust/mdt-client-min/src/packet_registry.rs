...
pub struct WellKnownRemotePacketIds {
    ...
    pub hide_follow_up_menu_packet_id: Option<u8>,
    pub info_toast_packet_id: Option<u8>,
    ...
    pub transfer_item_effect_packet_id: Option<u8>,
    pub transfer_item_to_packet_id: Option<u8>,
    pub transfer_item_to_unit_packet_id: Option<u8>,
...
impl WellKnownRemotePacketIds {
    ...
    fn from_resolved_packet_ids(
        ...
        Self {
            ...
            hide_follow_up_menu_packet_id: packet_id(WellKnownRemoteMethod::HideFollowUpMenu),
            info_toast_packet_id: packet_id(WellKnownRemoteMethod::InfoToast),
            ...
            transfer_item_effect_packet_id: packet_id(WellKnownRemoteMethod::TransferItemEffect),
            transfer_item_to_packet_id: packet_id(WellKnownRemoteMethod::TransferItemTo),
            transfer_item_to_unit_packet_id: packet_id(WellKnownRemoteMethod::TransferItemToUnit),
    ...
    pub fn packet_id(&self, method: WellKnownRemoteMethod) -> Option<u8> {
        match method {
            ...
            WellKnownRemoteMethod::HideFollowUpMenu => self.hide_follow_up_menu_packet_id,
            WellKnownRemoteMethod::InfoToast => self.info_toast_packet_id,
            ...
            WellKnownRemoteMethod::TransferItemEffect => self.transfer_item_effect_packet_id,
            WellKnownRemoteMethod::TransferItemTo => self.transfer_item_to_packet_id,
            WellKnownRemoteMethod::TransferItemToUnit => self.transfer_item_to_unit_packet_id,
...
mod tests {
    ...
    fn generated_remote_registry_constants_match_manifest_and_combined_views() {
        ...
        assert_eq!(
            combined.well_known_remote.hide_follow_up_menu_packet_id,
            Some(HIDE_FOLLOW_UP_MENU_CALL_PACKET_ID)
        );
        assert_eq!(
            combined.well_known_remote.info_toast_packet_id,
            Some(INFO_TOAST_CALL_PACKET_ID)
        );
        assert_eq!(
            combined.well_known_remote.set_hud_text_packet_id,
            Some(SET_HUD_TEXT_CALL_PACKET_ID)
        );
        assert_eq!(
            combined.well_known_remote.set_hud_text_reliable_packet_id,
            Some(SET_HUD_TEXT_RELIABLE_CALL_PACKET_ID)
        );
        assert_eq!(
            combined.well_known_remote.warning_toast_packet_id,
        ...
        assert_eq!(
            combined.well_known_remote.transfer_item_effect_packet_id,
            Some(TRANSFER_ITEM_EFFECT_CALL_PACKET_ID)
        );
        assert_eq!(
            combined.well_known_remote.transfer_item_to_packet_id,
            Some(TRANSFER_ITEM_TO_CALL_PACKET_ID)
        );
        assert_eq!(
            combined.well_known_remote.transfer_item_to_unit_packet_id,
            Some(TRANSFER_ITEM_TO_UNIT_CALL_PACKET_ID)
        );
        assert_eq!(
            manifest
                .remote_packets
    ...
    fn well_known_remote_packet_ids_reject_method_name_decoys() {
        ...
        assert_eq!(well_known.hide_follow_up_menu_packet_id, Some(99));
        assert_eq!(well_known.info_toast_packet_id, Some(101));
        ...
        assert_eq!(well_known.transfer_item_effect_packet_id, Some(129));
        assert_eq!(well_known.transfer_item_to_packet_id, Some(131));
        assert_eq!(well_known.transfer_item_to_unit_packet_id, Some(133));
        ...
        RemoteManifest {
            ...
            remote_packets: vec![
                ...
                remote_packet(
                    ...
                    "normal",
                    true,
                    vec![param("menuId", "int", true, true)],
                ),
                remote_packet(
                    95,
                    99,
                ...
                remote_packet(
                    124,
                    128,
                    "mindustry.gen.TransferItemEffectDecoyCallPacket",
                    "mindustry.input.InputHandler",
                    "transferItemEffect",
                    "server",
                    "normal",
                    ...
                    vec![
                        ...
                        param("x", "float", true, true),
                        param("y", "float", true, true),
                        param("to", "Itemsc", true, true),
                    ],
                ),
                remote_packet(
                    125,
                    129,
                    "mindustry.gen.TransferItemEffectCallPacket",
                    "mindustry.input.InputHandler",
                    "transferItemEffect",
                    "server",
                    "normal",
                ...
                remote_packet(
                    126,
                    130,
                    "mindustry.gen.TransferItemToDecoyCallPacket",
                    "mindustry.input.InputHandler",
                    "transferItemTo",
                    "server",
                    "normal",
                ...
                remote_packet(
                    128,
                    132,
                    "mindustry.gen.TransferItemToUnitDecoyCallPacket",
                    "mindustry.input.InputHandler",
                    "transferItemToUnit",
                    "server",
                    "normal",
                ...
                remote_packet(
                    129,
                    133,
                    "mindustry.gen.TransferItemToUnitCallPacket",
                    "mindustry.input.InputHandler",
                    "transferItemToUnit",
                    "server",
                    "normal",
